...
class TestListPL(unittest.TestCase):
    ...
    def test_list_prefix_lists_with_filters(self):
        ...
        self.assertEqual(len(result), 3, "Should find 3 prefix lists for this account.")
        ...
        self.assertEqual(
            len(result_alpha), 1, "Should only find 1 prefix list containing 'Alpha'."
        )
        ...
        self.assertEqual(len(result_exclude), 2, "Should exclude 'pl-003' from results.")
